...
(async () => {
    ...
    await page.keyboard.type('Arbitrum One');
  
    // Trigger an additional key press to select the option
    await page.keyboard.press('Enter');
  
    const input = await page.$('#__next > div > div > div.sc-889ee977-0.gCbopq > main > div.sc-55ee4011-1.cZHlms > div.sc-55ee4011-3.dlZmAt > div.sc-55ee4011-0.iXoIVV > div.css-1urcov8 > div:nth-child(1) > div.css-1k491an > div > input');
    await input.click({ clickCount: 3 })
    await page.type('#__next > div > div > div.sc-889ee977-0.gCbopq > main > div.sc-55ee4011-1.cZHlms > div.sc-55ee4011-3.dlZmAt > div.sc-55ee4011-0.iXoIVV > div.css-1urcov8 > div:nth-child(1) > div.css-1k491an > div > input','12');
